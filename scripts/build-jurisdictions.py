...
COUNTRIES = {
    'DE': {
        ...
        'insights': [
            ...
            ('독일에 자회사', '독일에 자회사를 둔 다국적기업그룹은 2023-12-31 이후 개시 사업연도부터 독일 QDMTT 적용 대상입니다. 독일 QDMTT는 OECD Central Record에 적격으로 등재되어 있어, QDMTT Safe Harbour를 활용하면 모기업 등의 소재지국에서 IIR/UTPR 계산이 면제됩니다.'),
            ('EU 통일 적용', '독일 외 EU 회원국들도 동일한 Directive 2022/2523을 transposition한 결과 시행일·구조가 거의 일치합니다. EU 내 다국가 그룹은 EU 회원국 간 적용 우선순위를 표준화된 OECD 규정으로 결정할 수 있어 비교적 예측 가능합니다.'),
        ],
        'recent': [
    ...
    'FR': {
        ...
        'insights': [
            ...
            ('프랑스에 자회사', '프랑스에 자회사를 둔 다국적기업그룹은 2023-12-31 이후 개시 사업연도부터 프랑스 QDMTT 적용 대상입니다. QDMTT Safe Harbour 적용 시 모기업 등의 소재지국 IIR/UTPR 계산이 면제됩니다.'),
            ('EU 통일 적용', '프랑스 외 EU 회원국들도 동일한 EU Directive를 transposition한 결과 시행일·구조가 일치합니다. EU 내 다국가 그룹은 적용 우선순위를 표준화된 규정으로 결정 가능합니다.'),
        ],
        'recent': [
    ...
    'IT': {
        ...
        'insights': [
            ...
            ('이탈리아에 자회사', '이탈리아에 자회사를 둔 다국적기업그룹은 2023-12-31 이후 개시 사업연도부터 이탈리아 QDMTT 적용 대상입니다. QDMTT Safe Harbour 적용 시 모기업 등의 소재지국 IIR/UTPR 계산이 면제됩니다.'),
            ('EU 통일 적용', '이탈리아 외 EU 회원국들도 동일한 EU Directive를 transposition했으므로 시행일·구조가 일치합니다.'),
        ],
        'recent': [
            ('2024 ~ 현재', '후속 시행 가이드 및 OECD 행정지침 반영 개정'),
    ...
    'NL': {
        ...
        'insights': [
            ...
            ('네덜란드에 자회사', '네덜란드에 자회사를 둔 다국적기업그룹은 2023-12-31 이후 개시 사업연도부터 네덜란드 QDMTT 적용 대상입니다. QDMTT Safe Harbour 적용 시 모기업 등의 소재지국 IIR/UTPR 계산이 면제됩니다.'),
            ('EU 통일 적용', '네덜란드 외 EU 회원국들도 동일한 EU Directive를 transposition한 결과 시행일·구조가 일치합니다.'),
        ],
        'recent': [
            ('2024 ~ 현재', '후속 시행 가이드 및 OECD 행정지침 반영 개정'),
    ...
    'SG': {
        ...
        'insights': [
            ...
            ('싱가포르에 자회사', '싱가포르에 자회사를 둔 다국적기업그룹은 2025-01-01 이후 개시 사업연도부터 싱가포르 QDMTT 적용 대상입니다. QDMTT Safe Harbour 적용 시 모기업 등의 소재지국 IIR/UTPR 계산이 면제됩니다. 싱가포르의 표준 법인세율(17%)과 다양한 인센티브 영향으로 자회사 ETR이 15% 미만이 되는 경우가 적지 않으므로 사전 모델링 가치가 높습니다.'),
