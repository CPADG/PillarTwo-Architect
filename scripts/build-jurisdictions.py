...
COUNTRIES = {
    ...
    'IE': {
        ...
        'insights': [
            ...
            ('아일랜드에 자회사', '아일랜드에 자회사를 둔 다국적기업그룹은 2023-12-31 이후 개시 사업연도부터 아일랜드 QDTT(QDMTT) 적용 대상입니다. QDMTT Safe Harbour 적용 요건을 충족하면 모기업 등의 소재지국에서의 IIR/UTPR 계산이 면제될 수 있습니다. 아일랜드 표준 법인세율(12.5%)이 글로벌최저한세율(15%) 미만이므로 ETR이 15%를 하회하는 사례가 많아 사전 모델링이 특히 중요합니다.'),
    ...
    'AE': {
        ...
        'insights': [
            ('UAE에 자회사', 'UAE에 자회사를 둔 다국적기업그룹은 2025-01-01 이후 개시 사업연도부터 UAE QDMTT 적용 대상입니다. QDMTT Safe Harbour 적용 요건을 충족하면 모기업 등의 소재지국에서의 IIR/UTPR 계산이 면제될 수 있습니다. UAE 표준 법인세율(9%)이 글로벌최저한세율(15%) 미만이므로 ETR이 15%를 하회하는 사례가 많아 사전 모델링이 특히 중요합니다.'),
    ...
    'CH': {
        ...
        'insights': [
            ...
            ('헤드쿼터·금융 hub 특성', '스위스는 글로벌 본부·금융·연구 기능이 집중된 소재지국으로, 칸톤(주)별로 차등화된 법인세율과 특별 인센티브 영향으로 ETR이 15%를 하회하는 사례가 발생할 수 있습니다.'),
        ],
        'recent': [
    ...
    'VN': {
        ...
        'insights': [
            ('베트남에 모기업·자회사', '베트남에 모기업·자회사를 둔 다국적기업그룹은 2024-01-01 이후 개시 사업연도부터 베트남 IIR과 QDMTT 적용 대상입니다. QDMTT Safe Harbour 적용 요건을 충족하면 모기업 등의 소재지국에서의 IIR/UTPR 계산이 면제될 수 있습니다. 베트남 표준 법인세율(20%) 외에 다양한 세제 인센티브(첨단기술기업·경제구역 등) 영향으로 ETR이 15%를 하회하는 사례가 있어 사전 모델링 가치가 있습니다.'),
        ],
        'recent': [
    ...
    'TH': {
        ...
        'insights': [
            ('태국에 모기업·자회사', '태국에 모기업·자회사를 둔 다국적기업그룹은 2025-01-01 이후 개시 사업연도부터 IIR · UTPR · QDMTT 모두 적용 대상입니다. QDMTT Safe Harbour 적용 요건을 충족하면 모기업 등의 소재지국에서의 IIR/UTPR 계산이 면제될 수 있습니다. 태국 BOI(Board of Investment) 인센티브 영향으로 ETR이 15%를 하회하는 경우가 있어 사전 모델링 가치가 있습니다.'),
        ],
        'recent': [
    ...
    'HU': {
        ...
        'insights': [
            ('헝가리에 모기업·자회사', '헝가리에 모기업·자회사를 둔 다국적기업그룹은 2023-12-31 이후 개시 사업연도부터 IIR/QDMTT 적용 대상입니다. 헝가리 표준 법인세율(9%)이 글로벌최저한세율(15%)보다 낮으므로 ETR이 15%를 하회하는 사례가 많아 사전 모델링이 중요합니다.'),
        ],
        'recent': [
    ...
    'QA': {
        ...
        'insights': [
            ('카타르에 모기업·자회사', '카타르에 모기업·자회사를 둔 다국적기업그룹은 2025-01-01 이후 개시 사업연도부터 IIR/QDMTT 적용 대상입니다. 카타르 표준 법인세율(10%)이 글로벌최저한세율(15%) 미만이므로 ETR이 15%를 하회하는 사례가 많아 사전 모델링이 중요합니다.'),
        ],
        'recent': [
    ...
    'LI': {
        ...
        'insights': [
            ('리히텐슈타인에 모기업·자회사', '리히텐슈타인에 모기업·자회사를 둔 다국적기업그룹은 2024-01-01 이후 개시 사업연도부터 IIR/QDMTT 적용 대상입니다. 리히텐슈타인 표준 법인세율(12.5%)이 글로벌최저한세율(15%) 미만이므로 ETR이 15%를 하회하는 사례가 많아 사전 모델링이 중요합니다.'),
        ],
        'recent': [
  ...
  (function(){{
    ...
    document.querySelectorAll('.docs-lang-btn').forEach(b=>{{
      ...
      b.addEventListener('click',()=>{{
        const nl=b.dataset.lang;
        try{{ localStorage.setItem('p2a.lang', nl); }}catch(e){{}}
        if(nl==='en') location.href='/jurisdictions/en/{slug}';
        else if(nl==='ja') location.href='/jurisdictions/ja/{slug}';
      }});
    }});
  }})();
